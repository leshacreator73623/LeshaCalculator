...
namespace LeshaCalculator
{
    public partial class Form1 : Form
    {
        ...
        private void exitToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            exitCal = MessageBox.Show("Cofirm, if you want to exit?", "LeshaCalculator",
        ...
        private void button42_Click(object sender, EventArgs e)
        {
            double x;
            lblShowOp.Text = Convert.ToString((txtResult.Text) + "⁴");
            x = Convert.ToDouble(txtResult.Text) * Convert.ToDouble(txtResult.Text) * Convert.ToDouble(txtResult.Text) * Convert.ToDouble(txtResult.Text);
            txtResult.Text = Convert.ToString(x);
        }

        private void button49_Click(object sender, EventArgs e)
        {
            double x, a, b, c, d, f, g, h, i, j, k, l;
            lblShowOp.Text = Convert.ToString((txtResult.Text) + "¹¹");

            a = Convert.ToDouble(txtResult.Text);
            b = Convert.ToDouble(txtResult.Text);
            c = Convert.ToDouble(txtResult.Text);
            d = Convert.ToDouble(txtResult.Text);
            f = Convert.ToDouble(txtResult.Text);
            g = Convert.ToDouble(txtResult.Text);
            h = Convert.ToDouble(txtResult.Text);
            i = Convert.ToDouble(txtResult.Text);
            j = Convert.ToDouble(txtResult.Text);
            k = Convert.ToDouble(txtResult.Text);
            l = Convert.ToDouble(txtResult.Text);

            x = (a * b * c * d * f * g * h * i * j * k * l);
            txtResult.Text = Convert.ToString(x);
        }
        ...
        private void button41_Click(object sender, EventArgs e)
        {
            double x;
            lblShowOp.Text = Convert.ToString((txtResult.Text) + "⁵");
            x = Convert.ToDouble(txtResult.Text) * Convert.ToDouble(txtResult.Text) * Convert.ToDouble(txtResult.Text) * Convert.ToDouble(txtResult.Text) * Convert.ToDouble(txtResult.Text);
            txtResult.Text = Convert.ToString(x);
        }
        ...
        private void button44_Click(object sender, EventArgs e)
        {
            double x;
            lblShowOp.Text = Convert.ToString((txtResult.Text) + "⁶");
            x = Convert.ToDouble(txtResult.Text) * Convert.ToDouble(txtResult.Text) * Convert.ToDouble(txtResult.Text) * Convert.ToDouble(txtResult.Text) * Convert.ToDouble(txtResult.Text) * Convert.ToDouble(txtResult.Text);
            txtResult.Text = Convert.ToString(x);
        }
        ...
        private void button45_Click(object sender, EventArgs e)
        {
            ...
            x = (a * b * c * d * f * g * h * i * j * k);
            txtResult.Text = Convert.ToString(x);
        }

        private void button48_Click(object sender, EventArgs e)
        {
            double x, a, b, c, d, f, g, h, i, j, k, l, m;
            lblShowOp.Text = Convert.ToString((txtResult.Text) + "¹²");
